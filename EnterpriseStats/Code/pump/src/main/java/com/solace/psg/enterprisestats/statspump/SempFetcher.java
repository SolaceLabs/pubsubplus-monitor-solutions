...
public interface SempFetcher {

    public InputStream performStreamRequest(String sempRequest, String hostnameOrIp, String username, String password);
    public String performStringRequest(String sempRequest, String hostnameOrIp, String username, String password);
}
