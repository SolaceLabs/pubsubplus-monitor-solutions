...
public class Apache45Client {
	...
	/**
	 * Performs Http PUT against the specified URL, passing the specified body text in the post. Credentials are passed
	 * in the request header as basic authentication.
	 * @param uri
	 * @param username
	 * @param password
	 ...
	 * @throws HttpException
	 */
	public static String put(String uri, String username, String password, String body) throws HttpException {
	    ...
	    return execute(httpPut, username, password);
	}
	 ...
	 * @throws HttpException
	 */
	public static int head(String uri, String username, String password) throws HttpException {
