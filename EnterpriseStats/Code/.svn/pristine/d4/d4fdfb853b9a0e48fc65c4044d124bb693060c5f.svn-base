 ...
 * base layer.
 */
public enum JsonMapFactory2 implements ContainerFactory {
    ...
    protected static class SingleJsonMapContainer extends AbstractSingleContainer {
        ...
        public void closeNestedElement(String element) {
            String element2 = nestedElements.removeLast();
         ...
         * @param value
         */
        private void putJsonObject(String element, JSONObject value) {
