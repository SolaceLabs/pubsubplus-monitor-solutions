...
/**
 * Writes a log file containing http based Influx statements sent.
 */
public class InfluxLogger {
    private static final Logger logger = LoggerFactory.getLogger(InfluxLogger.class);
     ...
     */
    public InfluxLogger() {
        m_filename = generateFileName("InfluxHttp");
    ...
    public void writeLog(String line) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Failure writing Influx log file:", e);
        } finally {
            try {
                writer.flush();
                writer.close();
                ...
                e.printStackTrace();
                logger.error("Failure writing Influx log:", e);
            }
        }
    }
}
